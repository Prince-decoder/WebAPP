<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8"%>
<%@ page import="com.ashu.WebApplication.DataModel.JobPost" %>
...
<head>
    ...
    <style>
        ...
        .card-custom-sci-fi {
            ...
            color: #eee !important;
            margin-bottom: 20px;
            backdrop-filter: blur(5px); /* Adds a nice glass effect over the background */
        }
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark-sci-fi">
    <div class="container">
        <a class="navbar-brand fs-1 fw-medium text-sci-fi-red" href="#">Ashutosh Job Portal</a>
...
<div class="container mt-5">
    <h2 class="mb-4 text-center font-weight-bold dramatic-header">Job Post Details</h2>
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card card-custom-sci-fi">
                <div class="card-body">
                    <h5 class="card-title text-sci-fi-red"><%= myJobPost.getPostProfile() %></h5>
                    <p class="card-text">
